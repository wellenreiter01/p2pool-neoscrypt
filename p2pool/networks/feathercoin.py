...
VERSION_WARNING = lambda v:'Upgrade Feathercoin to  0.8.7.3!' if v < 80703 else 'Upgrade Feathercoin to 0.9.3.1!' if v < 90301 else 'Downgrade Feathercoin to 0.9.3.1!' if v > 90301 else None
